...
20 REM ON APPLE II 78 AND 79 ARE A HARDWARE COUNTER
30 R=INT(RND(-(PEEK(78)+256*PEEK(79)))*100)+1
40 PRINT "GUESS MY NUMBER (1-100)."
50 FOR T=7 TO 1 STEP -1
60 IF T>1 THEN PRINT "YOU HAVE ";T;" TRIES REMAINING.":GOTO 80
70 PRINT "THIS IS YOUR LAST TRY!"
80 INPUT "YOUR GUESS? ";G
90 IF G<R THEN PRINT "TOO LOW":GOTO 130
100 IF G>R THEN PRINT "TOO HIGH":GOTO 130
...
40 FOR PY=0 TO 39
50 FOR PX=0 TO 39
60 COLOR 15:PLOT PX,PY
70 REM MAP SCREEN TO COMPLEX PLANE
80 CA=(PX/39)*2.5-2.0:CB=(PY/39)*2.4-1.2
90 ZA=0:ZB=0
